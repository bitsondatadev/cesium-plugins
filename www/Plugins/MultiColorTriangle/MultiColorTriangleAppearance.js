...
define([
        'Cesium',
        'MultiColorTriangle/Shaders/MultiColorTriangleAppearanceFS',
        'MultiColorTriangle/Shaders/MultiColorTriangleAppearanceVS'
    ], function(
        Cesium,
        MultiColorTriangleAppearanceFS,
        MultiColorTriangleAppearanceVS
        ) {
    "use strict";
    ...
    return MultiColorTriangleAppearance;
});